...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            if (parts.Length != 4)
            {
                Console.WriteLine("Command not valid, Create requires a name, type and type of gradebook, if it's weighted (true / false).");
                return;
            }
            var name = parts[1];
            ...
            if (parts[2] == "ranked" & parts[3] == "true")
            {
            ...
            if (parts[2] == "ranked" & parts[3] == "false")
            {
                BaseGradeBook gradeBook = new RankedGradeBook(name, false);
                GradeBookUserInterface.CommandLoop(gradeBook);
            }
